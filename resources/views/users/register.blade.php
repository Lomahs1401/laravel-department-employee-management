        ...
        <div class="mx-auto bg-blue-300 px-4 py-6 pt-3 mt-20 w-2/5 rounded-xl">
            ...
            <form action="/users" method="POST">
                ...
                <div class="rounded-xl p-4 bg-white w-auto">
                    <div class="mb-6">
                        <label for="email" class="block mb-2 text-md font-medium text-black dark:text-white">Email:</label>
                        <input type="text" id="email" class="bg-gray-50 border border-gray-300 
                    ...
                    <div class="mt-8 text-center">
                        <p>
                          Đã có tài khoản?
                          <a href="/login" class="text-blue-500">Đăng nhập tại đây</a>
                        </p>
                    </div>
                </div>
            </form>
